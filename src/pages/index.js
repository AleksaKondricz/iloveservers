      ...
      <section className={styles.homeContainer}>
        <div className={styles.hero}>
          ...
          <h2>
            ...
            businesses thrive by providing them with top notch software
            solutions. You tell us what, we take care of the how.
          </h2>
          ...
          <div className={styles.aboutContainer}>
            <Fade ssrFadeout left>
              <div className={styles.aboutTextWrapper}>
                <h2>
                  We are crafting unique software solutions. We transform a set
                  of business requirements into a working, living product under
            ...
            {aboutUsList.map(i => (
              <li key={i.id}>{i.content}</li>
                ...
                <p>
                  ...
                  integrations. However at the moment, we prefer to work
                  remotely. We are based in GMT +1, but we are not scared to
                  work with someone from different time zones. We can adjust the
                  working hours based on the mutual agreements. We are always
                  accessible, communicate a lot, and love automating slack
                  channels.
                </p>
              </div>
            </Fade>
      ...
      <section className={styles.technologiesContainer} id="technologies">
        ...
        <Fade ssrFadeout right>
          <div className={styles.shortIntro}>
            <p>
              We have a recommended set of technologies, what can achieve a
              really fast MVP, but able to scale well both horizontally and
              vertically. Our stack is based on javascript, and considered to be
              very progressive. We love new stuff, but we understand the
              importance of legacy systems as well. We learn fast, adapt easily,
              and happy to face challenging technologies outside of our comfort
              zone.
            </p>
          </div>
        </Fade>
        ...
        <Fade ssrFadeout bottom>
          <div className={styles.projectsContainer}>
            <NavSlider
              previous="<"
              next=">"
              elements={copy.projects.map(project => ({
                id: project.id,
